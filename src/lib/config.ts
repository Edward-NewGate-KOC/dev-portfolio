...
export const siteConfig: SiteConfig = {
    ...
    systemSpecs: [
        { label: "OS / DE", value: "KDE neon / KDE Plasma 6.6", icon: Monitor },
        ...
        { label: "Editors", value: "RustRover, Android Studio, VS Code", icon: Terminal },
    ],
    availability: {
        isAvailable: true,
...
export const skills: Skill[] = [
    ...
    },
    {
        ...
        description: "Really comfortable reading and editing Smali (Dalvik bytecode). Years of Android modding and patching APKs using MT manager and NP manager"
    },
    {
        name: "Frida",
        mastery: 80,
